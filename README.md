...
<p align="left">
  ...
  <img alt="public extract" src="https://img.shields.io/badge/public%20extract-7%2C409%20rows-8250df">
...
**Public extract:** 7,409 rows · **Live catalog:** 7,409 domains
...
- `ltd.csv` — public CSV extract (7,409 rows)
- `ltd.json` — public JSON extract (7,409 rows)
...
| ----------------------- | ------------------------------------------------ |
| 7,409-row public sample | 7,409 live domains                               |
...
> Unique Domains. *Available .LTD One-Word Domains*. Version 2026-04-12. Public GitHub extract for the exact Unique Domains search represented by this repository.
